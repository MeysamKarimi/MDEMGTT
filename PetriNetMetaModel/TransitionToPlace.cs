...
namespace MDEMGTT.PetriNet
{
    ...
    /// <summary>
    /// The default implementation of the TransitionToPlace class
    /// </summary>
    ...
    [DebuggerDisplayAttribute("TransitionToPlace {Name}")]
    public partial class TransitionToPlace : Arc, ITransitionToPlace, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new TransitionToPlaceReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://petrinet/1.0#//TransitionToPlace")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.PetriNet.TransitionToPlace.ClassInstance)).Resolve("from")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.PetriNet.TransitionToPlace.ClassInstance)).Resolve("to")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the TransitionToPlace class
        /// </summary>
        public class TransitionToPlaceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private TransitionToPlace _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public TransitionToPlaceReferencedElementsCollection(TransitionToPlace parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class FromProxy : ModelPropertyChange<ITransitionToPlace, ITransition>
        {
            ...
            public FromProxy(ITransitionToPlace modelElement) : 
        ...
        /// </summary>
        private sealed class ToProxy : ModelPropertyChange<ITransitionToPlace, IPlace>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ToProxy(ITransitionToPlace modelElement) : 
