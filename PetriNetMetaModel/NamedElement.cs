...
namespace MDEMGTT.PetriNet
{
    ...
    [ModelRepresentationClassAttribute("http://petrinet/1.0#//NamedElement")]
    [DebuggerDisplayAttribute("NamedElement {Name}")]
    public abstract partial class NamedElement : LocatedElement, INamedElement, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://petrinet/1.0#//NamedElement")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.PetriNet.NamedElement.ClassInstance)).Resolve("name")));
        }
