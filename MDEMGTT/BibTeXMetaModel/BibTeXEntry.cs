...
namespace MDEMGTT.BibTeX
{
    ...
    [ModelRepresentationClassAttribute("http://bibtex/1.0#//BibTeXEntry")]
    public abstract partial class BibTeXEntry : ModelElement, IBibTeXEntry, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://bibtex/1.0#//BibTeXEntry")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.BibTeX.BibTeXEntry.ClassInstance)).Resolve("id")));
        }
