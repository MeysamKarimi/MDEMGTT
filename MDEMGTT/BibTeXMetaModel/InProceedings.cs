...
namespace MDEMGTT.BibTeX
{
    ...
    [ModelRepresentationClassAttribute("http://bibtex/1.0#//InProceedings")]
    public partial class InProceedings : Proceedings, IInProceedings, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://bibtex/1.0#//InProceedings")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.BibTeX.AuthoredEntry.ClassInstance)).Resolve("authors")));
        }
