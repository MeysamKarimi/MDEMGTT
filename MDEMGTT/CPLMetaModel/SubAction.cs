...
namespace MDEMGTT.CPL
{
    ...
    /// <summary>
    /// The default implementation of the SubAction class
    /// </summary>
    ...
    public partial class SubAction : NodeContainer, ISubAction, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://cpl/1.0#//SubAction")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.CPL.SubAction.ClassInstance)).Resolve("id")));
        }
        ...
        /// </summary>
        private sealed class IdProxy : ModelPropertyChange<ISubAction, string>
        {
            ...
            public IdProxy(ISubAction modelElement) : 
