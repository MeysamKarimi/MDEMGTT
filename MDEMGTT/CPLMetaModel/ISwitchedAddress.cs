...
namespace MDEMGTT.CPL
{
    ...
    /// <summary>
    /// The public interface for SwitchedAddress
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(SwitchedAddress))]
    [XmlDefaultImplementationTypeAttribute(typeof(SwitchedAddress))]
    [ModelRepresentationClassAttribute("http://cpl/1.0#//SwitchedAddress")]
    public interface ISwitchedAddress : IModelElement, INodeContainer
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> SubDomainOfChanging;
        
        /// <summary>
        /// Gets fired when the SubDomainOf property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> SubDomainOfChanged;
    }
}
