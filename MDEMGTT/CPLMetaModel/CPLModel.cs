...
namespace MDEMGTT.CPL
{
    ...
    /// <summary>
    /// The default implementation of the CPLModel class
    /// </summary>
    [XmlNamespaceAttribute("http://cpl/1.0")]
    [XmlNamespacePrefixAttribute("CPL")]
    [ModelRepresentationClassAttribute("http://cpl/1.0#//CPLModel")]
    public partial class CPLModel : ModelElement, ICPLModel, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new CPLModelChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new CPLModelReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://cpl/1.0#//CPLModel")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.CPL.CPLModel.ClassInstance)).Resolve("elements")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the CPLModel class
        /// </summary>
        public class CPLModelChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private CPLModel _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public CPLModelChildrenCollection(CPLModel parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the CPLModel class
        /// </summary>
        public class CPLModelReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public CPLModelReferencedElementsCollection(CPLModel parent)
            {
                this._parent = parent;
            }
