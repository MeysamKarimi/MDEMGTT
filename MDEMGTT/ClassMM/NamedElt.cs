...
namespace MDEMGTT.Class
{
    ...
    [ModelRepresentationClassAttribute("http://class/1.0#//NamedElt")]
    ...
    public abstract partial class NamedElt : ModelElement, INamedElt, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://class/1.0#//NamedElt")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.Class.NamedElt.ClassInstance)).Resolve("name")));
        }
