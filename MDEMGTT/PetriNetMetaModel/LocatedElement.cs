    ...
    public abstract partial class LocatedElement : ModelElement, ILocatedElement, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://petrinet/1.0#//LocatedElement")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.PetriNet.LocatedElement.ClassInstance)).Resolve("location")));
        }
