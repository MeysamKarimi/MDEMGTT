...
namespace MDEMGTT.Grafcet
{
    ...
    /// <summary>
    /// The default implementation of the StepToTransition class
    /// </summary>
    ...
    [DebuggerDisplayAttribute("StepToTransition {Name}")]
    public partial class StepToTransition : Connection, IStepToTransition, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new StepToTransitionReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://grafcet/1.0#//StepToTransition")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.Grafcet.StepToTransition.ClassInstance)).Resolve("from")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(MDEMGTT.Grafcet.StepToTransition.ClassInstance)).Resolve("to")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the StepToTransition class
        /// </summary>
        public class StepToTransitionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private StepToTransition _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public StepToTransitionReferencedElementsCollection(StepToTransition parent)
            {
                this._parent = parent;
            }
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.From == null))
                {
                    IStep fromCasted = item.As<IStep>();
                    if ((fromCasted != null))
                    {
        ...
        /// </summary>
        private sealed class FromProxy : ModelPropertyChange<IStepToTransition, IStep>
        {
            ...
            public FromProxy(IStepToTransition modelElement) : 
        ...
        /// </summary>
        private sealed class ToProxy : ModelPropertyChange<IStepToTransition, ITransition>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ToProxy(IStepToTransition modelElement) : 
