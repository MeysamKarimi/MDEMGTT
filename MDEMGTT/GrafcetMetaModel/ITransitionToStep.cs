...
namespace MDEMGTT.Grafcet
{
    ...
    /// <summary>
    /// The public interface for TransitionToStep
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(TransitionToStep))]
    [XmlDefaultImplementationTypeAttribute(typeof(TransitionToStep))]
    [ModelRepresentationClassAttribute("http://grafcet/1.0#//TransitionToStep")]
    public interface ITransitionToStep : IModelElement, IConnection
    {
